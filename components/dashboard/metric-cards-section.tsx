                ...
                <Dialog>
                    ...
                    <DialogContent className="sm:max-w-[720px] max-h-[80vh] overflow-y-auto p-0">
                        <DialogHeader className="p-4 border-b border-[#d9dede]">
                            ...
                            <DialogDescription>
                                Understanding your organization&apos;s overall
                        ...
                        <div className="flex flex-col gap-4 items-start p-4 relative shrink-0 w-full">
                            ...
                            <div className="flex flex-col gap-4 items-start relative shrink-0 w-full">
                                ...
                                <p className="text-base font-normal text-[#5d6c6b] leading-6 w-full">
                                    Company Health is a comprehensive metric
                                    that measures the overall well-being and
                                    performance of your organization. It
                                    combines five key dimensions to provide a
                                    holistic view of how your company is
                                    performing across people, culture, and
                                    operations.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col gap-4 items-start relative shrink-0 w-full">
                                ...
                                <div className="flex gap-6 items-start relative shrink-0 w-full">
                                    ...
                                    <div className="flex flex-col gap-2 flex-1 items-start justify-center min-w-0 w-full">
                                        ...
                                        <p className="text-base font-normal text-[#5d6c6b] leading-6 w-full">
                                            Excellent health. Your organization
                                            is performing well across all
                                            dimensions.
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-2 flex-1 items-start justify-center min-w-0 w-full">
                                        ...
                                        <p className="text-base font-normal text-[#5d6c6b] leading-6 w-full">
                                            Good health. Room for improvement in
                                            specific areas.
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-2 flex-1 items-start justify-center min-w-0 w-full">
                                        ...
                                        <p className="text-base font-normal text-[#5d6c6b] leading-6 w-full">
                                            Needs attention. Focus on improving
                                            key components.
                                        </p>
                                    </div>
                                </div>
